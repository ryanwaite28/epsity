...
class Comments(models.Model):
    ...
    owner = models.ForeignKey(choices = OwnerType, default = 0, related_name = "comment_owner")
    ownerid = models.IntegerField(blank = False, default = 0)
    owner_type = models.CharField(blank = False, default = '', max_length = 50)
...
class Replies(models.Model):
    ...
    owner = models.ForeignKey(choices = OwnerType, default = 0, related_name = "reply_owner")
    ownerid = models.IntegerField(blank = False, default = 0)
    owner_type = models.CharField(blank = False, default = '', max_length = 50)
...
class Likes(models.Model):
    ...
    owner = models.ForeignKey(limit_choices_to = OwnerType, default = 0, related_name = "like_owner")
    ownerid = models.IntegerField(blank = False, default = 0)
    owner_type = models.CharField(blank = False, default = '', max_length = 50)
...
class Events(models.Model):
    ...
    owner = models.ForeignKey(choices = OwnerType, default = 0, related_name = "event_owner")
    ownerid = models.IntegerField(blank = False, default = 0, on_delete = models.CASCADE)
    owner_type = models.CharField(blank = False, default = '', max_length = 50)
...
class EventAttendees(models.Model):
    ...
    attendee = models.ForeignKey(choices = AttendeeType, default = 0, related_name = "event_attendee_owner")
    attendee_id = models.IntegerField(blank = False, default = 0)
    attendee_type = models.CharField(blank = False, default = '', max_length = 50)
    ...
    def serialize(self):
        return {
            ...
            'attendee': self.attendee.serialize,
